...
export const carsTypeSort = {
  truckSort: [
    ...
    { label: "Ռեֆրեժիրատոր" },
    { label: "Մանիպուլյատոր" },
    { label: "Բեռնասայլ/Ֆուրգոն" },
  ],
  motoTechSort: [
    { label: "Մոտոցիկլ" },
    { label: "Սկուտեր/Մոպեդ" },
    { label: "Սպայդեր/Տրիցիկլ" },
    { label: "Կվադրացիկլ/Բագգի" },
    { label: "Ձյունագնաց" },
  ],
  specTechSort: [
    { label: "Ավտոաշտարակ" },
